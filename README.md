...
├── background.js       # Service worker — scraper, auto-scan queue, cache helpers
├── content.js          # Content script — job change detection, People tab observer
├── popup.html          # Side panel UI — HTML + all CSS
├── popup.js            # Side panel logic — all UI interactions, state management
