...
function updateCompanyMetaDisplay() {
  ...
  if (parts.length > 0) {
    ...
    if (_onJobPage) html += `<button class="copy-jd-chip" id="copyJdBtn">&#128203; JD</button><button class="copy-jd-chip" id="pasteJdBtn">&#9998; Paste JD</button><button class="copy-jd-chip" id="pasteJdImgBtn">&#128247; Paste JD IMG</button><button class="copy-jd-chip" id="answerQuestionBtn">&#10022; Answer</button><a class="copy-jd-chip" id="openJobBtn" href="${_currentJobUrl}" target="_blank">&#8599; Open</a>`;
    ...
    if (_onJobPage) {
      ...
      document.getElementById('pasteJdImgBtn').addEventListener('click', handlePasteJdImg);
